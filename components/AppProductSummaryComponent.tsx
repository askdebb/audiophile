      ...
      <div className=" bg-white p-5 rounded-radius">
          ...
          {cartItems.map((finalItemToPurchase, index) => (
            <div key={index} className="flex items-center justify-between my-3">
              <div className="flex gap-x-3">
                <Card className="w-20 h-20 bg-[#fafafa] shadow-none">
              ...
              <span className="-mt-7 font-medium opacity-50">
        ...
        <div>
          <div className="flex justify-between items-center w-full my-1">
            <span className="uppercase text-16 opacity-40">Total:</span>
            <span className="font-extrabold text-h6 tracking-subtitle">
              {`$${checkComma(grossPrice)}`}
            </span>
          </div>
          <div className="flex justify-between items-center w-full my-1">
            <span className="uppercase text-16 opacity-40">shipping:</span>
            <span className="font-extrabold text-h6 tracking-subtitle">
              {`$${SHIPPING_FEE}`}
            </span>
          </div>
          <div className="flex justify-between items-center w-full my-1">
            <span className="uppercase text-16 opacity-40">vat (included)</span>
            <span className="font-extrabold text-h6 tracking-subtitle">
              {`$${checkComma(vatPrice)}`}
            </span>
          </div>

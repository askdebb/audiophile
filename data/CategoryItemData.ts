...
export const categoryHeadphoneData: Product[] = [
  {
    id: 1,
...

  {
    ...
    image: {
      mobile: '/assets/category/mobile/headphones/headphone-1.png',
      tablet:
  ...
  },
  {
    ...
    image: {
      mobile: '/assets/category/mobile/headphones/headphone-59.png',
...
export const categorySpeakerData: Product[] = [
  {
    id: 1,
    slug: 'zx9-speaker',
    name: 'ZX9 Speaker',
    image: {
      mobile: '/assets/category/mobile/speakers/zx9-speaker.png',
  ...
  },
  {
    ...
    name: 'ZX7 Speaker',
    image: {
      mobile: '/assets/category/mobile/speakers/zx7-speaker.png',
...
export const categoryEarphoneData: Product[] = [
  {
    id: 1,
    slug: 'yx1-earphones',
    name: 'YX1 Wireless Earphones',
    image: {
      mobile: '/assets/category/mobile/earphones/yx1-wireless-earphone.png',
